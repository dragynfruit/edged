...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_TENSOR_TYPE: i8 = 18;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_TENSOR_TYPE: [TensorType; 19] = [
  TensorType::FLOAT32,
  TensorType::FLOAT16,
  TensorType::INT32,
  TensorType::UINT8,
...
impl TensorType {
  ...
  pub const BFLOAT16: Self = Self(18);
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_BUILTIN_OPERATOR: i32 = 206;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_BUILTIN_OPERATOR: [BuiltinOperator; 207] = [
  BuiltinOperator::ADD,
...
impl BuiltinOperator {
  ...
  pub const STABLEHLO_LOGISTIC: Self = Self(162);
  pub const STABLEHLO_ADD: Self = Self(163);
  pub const STABLEHLO_DIVIDE: Self = Self(164);
  pub const STABLEHLO_MULTIPLY: Self = Self(165);
  pub const STABLEHLO_MAXIMUM: Self = Self(166);
  pub const STABLEHLO_RESHAPE: Self = Self(167);
  pub const STABLEHLO_CLAMP: Self = Self(168);
  pub const STABLEHLO_CONCATENATE: Self = Self(169);
  pub const STABLEHLO_BROADCAST_IN_DIM: Self = Self(170);
  pub const STABLEHLO_CONVOLUTION: Self = Self(171);
  pub const STABLEHLO_SLICE: Self = Self(172);
  pub const STABLEHLO_CUSTOM_CALL: Self = Self(173);
  pub const STABLEHLO_REDUCE: Self = Self(174);
  pub const STABLEHLO_ABS: Self = Self(175);
  pub const STABLEHLO_AND: Self = Self(176);
  pub const STABLEHLO_COSINE: Self = Self(177);
  pub const STABLEHLO_EXPONENTIAL: Self = Self(178);
  pub const STABLEHLO_FLOOR: Self = Self(179);
  pub const STABLEHLO_LOG: Self = Self(180);
  pub const STABLEHLO_MINIMUM: Self = Self(181);
  pub const STABLEHLO_NEGATE: Self = Self(182);
  pub const STABLEHLO_OR: Self = Self(183);
  pub const STABLEHLO_POWER: Self = Self(184);
  pub const STABLEHLO_REMAINDER: Self = Self(185);
  pub const STABLEHLO_RSQRT: Self = Self(186);
  pub const STABLEHLO_SELECT: Self = Self(187);
  pub const STABLEHLO_SUBTRACT: Self = Self(188);
  pub const STABLEHLO_TANH: Self = Self(189);
  pub const STABLEHLO_SCATTER: Self = Self(190);
  pub const STABLEHLO_COMPARE: Self = Self(191);
  pub const STABLEHLO_CONVERT: Self = Self(192);
  pub const STABLEHLO_DYNAMIC_SLICE: Self = Self(193);
  pub const STABLEHLO_DYNAMIC_UPDATE_SLICE: Self = Self(194);
  pub const STABLEHLO_PAD: Self = Self(195);
  pub const STABLEHLO_IOTA: Self = Self(196);
  pub const STABLEHLO_DOT_GENERAL: Self = Self(197);
  pub const STABLEHLO_REDUCE_WINDOW: Self = Self(198);
  pub const STABLEHLO_SORT: Self = Self(199);
  pub const STABLEHLO_WHILE: Self = Self(200);
  pub const STABLEHLO_GATHER: Self = Self(201);
  pub const STABLEHLO_TRANSPOSE: Self = Self(202);
  pub const DILATE: Self = Self(203);
  pub const STABLEHLO_RNG_BIT_GENERATOR: Self = Self(204);
  pub const REDUCE_WINDOW: Self = Self(205);
  pub const STABLEHLO_COMPOSITE: Self = Self(206);

  pub const ENUM_MIN: i32 = 0;
  pub const ENUM_MAX: i32 = 206;
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::ADD,
    ...
    Self::BITWISE_XOR,
    Self::RIGHT_SHIFT,
    Self::STABLEHLO_LOGISTIC,
    Self::STABLEHLO_ADD,
    Self::STABLEHLO_DIVIDE,
    Self::STABLEHLO_MULTIPLY,
    Self::STABLEHLO_MAXIMUM,
    Self::STABLEHLO_RESHAPE,
    Self::STABLEHLO_CLAMP,
    Self::STABLEHLO_CONCATENATE,
    Self::STABLEHLO_BROADCAST_IN_DIM,
    Self::STABLEHLO_CONVOLUTION,
    Self::STABLEHLO_SLICE,
    Self::STABLEHLO_CUSTOM_CALL,
    Self::STABLEHLO_REDUCE,
    Self::STABLEHLO_ABS,
    Self::STABLEHLO_AND,
    Self::STABLEHLO_COSINE,
    Self::STABLEHLO_EXPONENTIAL,
    Self::STABLEHLO_FLOOR,
    Self::STABLEHLO_LOG,
    Self::STABLEHLO_MINIMUM,
    Self::STABLEHLO_NEGATE,
    Self::STABLEHLO_OR,
    Self::STABLEHLO_POWER,
    Self::STABLEHLO_REMAINDER,
    Self::STABLEHLO_RSQRT,
    Self::STABLEHLO_SELECT,
    Self::STABLEHLO_SUBTRACT,
    Self::STABLEHLO_TANH,
    Self::STABLEHLO_SCATTER,
    Self::STABLEHLO_COMPARE,
    Self::STABLEHLO_CONVERT,
    Self::STABLEHLO_DYNAMIC_SLICE,
    Self::STABLEHLO_DYNAMIC_UPDATE_SLICE,
    Self::STABLEHLO_PAD,
    Self::STABLEHLO_IOTA,
    Self::STABLEHLO_DOT_GENERAL,
    Self::STABLEHLO_REDUCE_WINDOW,
    Self::STABLEHLO_SORT,
    Self::STABLEHLO_WHILE,
    Self::STABLEHLO_GATHER,
    Self::STABLEHLO_TRANSPOSE,
    Self::DILATE,
    Self::STABLEHLO_RNG_BIT_GENERATOR,
    Self::REDUCE_WINDOW,
    Self::STABLEHLO_COMPOSITE,
  ];
  /// Returns the variant's name or "" if unknown.
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::STABLEHLO_LOGISTIC => Some("STABLEHLO_LOGISTIC"),
      Self::STABLEHLO_ADD => Some("STABLEHLO_ADD"),
      Self::STABLEHLO_DIVIDE => Some("STABLEHLO_DIVIDE"),
      Self::STABLEHLO_MULTIPLY => Some("STABLEHLO_MULTIPLY"),
      Self::STABLEHLO_MAXIMUM => Some("STABLEHLO_MAXIMUM"),
      Self::STABLEHLO_RESHAPE => Some("STABLEHLO_RESHAPE"),
      Self::STABLEHLO_CLAMP => Some("STABLEHLO_CLAMP"),
      Self::STABLEHLO_CONCATENATE => Some("STABLEHLO_CONCATENATE"),
      Self::STABLEHLO_BROADCAST_IN_DIM => Some("STABLEHLO_BROADCAST_IN_DIM"),
      Self::STABLEHLO_CONVOLUTION => Some("STABLEHLO_CONVOLUTION"),
      Self::STABLEHLO_SLICE => Some("STABLEHLO_SLICE"),
      Self::STABLEHLO_CUSTOM_CALL => Some("STABLEHLO_CUSTOM_CALL"),
      Self::STABLEHLO_REDUCE => Some("STABLEHLO_REDUCE"),
      Self::STABLEHLO_ABS => Some("STABLEHLO_ABS"),
      Self::STABLEHLO_AND => Some("STABLEHLO_AND"),
      Self::STABLEHLO_COSINE => Some("STABLEHLO_COSINE"),
      Self::STABLEHLO_EXPONENTIAL => Some("STABLEHLO_EXPONENTIAL"),
      Self::STABLEHLO_FLOOR => Some("STABLEHLO_FLOOR"),
      Self::STABLEHLO_LOG => Some("STABLEHLO_LOG"),
      Self::STABLEHLO_MINIMUM => Some("STABLEHLO_MINIMUM"),
      Self::STABLEHLO_NEGATE => Some("STABLEHLO_NEGATE"),
      Self::STABLEHLO_OR => Some("STABLEHLO_OR"),
      Self::STABLEHLO_POWER => Some("STABLEHLO_POWER"),
      Self::STABLEHLO_REMAINDER => Some("STABLEHLO_REMAINDER"),
      Self::STABLEHLO_RSQRT => Some("STABLEHLO_RSQRT"),
      Self::STABLEHLO_SELECT => Some("STABLEHLO_SELECT"),
      Self::STABLEHLO_SUBTRACT => Some("STABLEHLO_SUBTRACT"),
      Self::STABLEHLO_TANH => Some("STABLEHLO_TANH"),
      Self::STABLEHLO_SCATTER => Some("STABLEHLO_SCATTER"),
      Self::STABLEHLO_COMPARE => Some("STABLEHLO_COMPARE"),
      Self::STABLEHLO_CONVERT => Some("STABLEHLO_CONVERT"),
      Self::STABLEHLO_DYNAMIC_SLICE => Some("STABLEHLO_DYNAMIC_SLICE"),
      Self::STABLEHLO_DYNAMIC_UPDATE_SLICE => Some("STABLEHLO_DYNAMIC_UPDATE_SLICE"),
      Self::STABLEHLO_PAD => Some("STABLEHLO_PAD"),
      Self::STABLEHLO_IOTA => Some("STABLEHLO_IOTA"),
      Self::STABLEHLO_DOT_GENERAL => Some("STABLEHLO_DOT_GENERAL"),
      Self::STABLEHLO_REDUCE_WINDOW => Some("STABLEHLO_REDUCE_WINDOW"),
      Self::STABLEHLO_SORT => Some("STABLEHLO_SORT"),
      Self::STABLEHLO_WHILE => Some("STABLEHLO_WHILE"),
      Self::STABLEHLO_GATHER => Some("STABLEHLO_GATHER"),
      Self::STABLEHLO_TRANSPOSE => Some("STABLEHLO_TRANSPOSE"),
      Self::DILATE => Some("DILATE"),
      Self::STABLEHLO_RNG_BIT_GENERATOR => Some("STABLEHLO_RNG_BIT_GENERATOR"),
      Self::REDUCE_WINDOW => Some("REDUCE_WINDOW"),
      Self::STABLEHLO_COMPOSITE => Some("STABLEHLO_COMPOSITE"),
      _ => None,
    }
  }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_BUILTIN_OPTIONS_2: u8 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_BUILTIN_OPTIONS_2: u8 = 21;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_BUILTIN_OPTIONS_2: [BuiltinOptions2; 22] = [
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct BuiltinOptions2(pub u8);
#[allow(non_upper_case_globals)]
impl BuiltinOptions2 {
  pub const NONE: Self = Self(0);
  pub const StablehloConcatenateOptions: Self = Self(1);
  pub const StablehloBroadcastInDimOptions: Self = Self(2);
  pub const StablehloSliceOptions: Self = Self(3);
  pub const StablehloConvolutionOptions: Self = Self(4);
  pub const StablehloCustomCallOptions: Self = Self(5);
  pub const StablehloReduceOptions: Self = Self(6);
  pub const StablehloScatterOptions: Self = Self(7);
  pub const StablehloCompareOptions: Self = Self(8);
  pub const StablehloDynamicSliceOptions: Self = Self(9);
  pub const StablehloPadOptions: Self = Self(10);
  pub const StablehloIotaOptions: Self = Self(11);
  pub const StablehloDotGeneralOptions: Self = Self(12);
  pub const StablehloReduceWindowOptions: Self = Self(13);
  pub const StablehloSortOptions: Self = Self(14);
  pub const StablehloWhileOptions: Self = Self(15);
  pub const StablehloGatherOptions: Self = Self(16);
  pub const StablehloTransposeOptions: Self = Self(17);
  pub const DilateOptions: Self = Self(18);
  pub const StablehloRngBitGeneratorOptions: Self = Self(19);
  pub const ReduceWindowOptions: Self = Self(20);
  pub const StableHLOCompositeOptions: Self = Self(21);

  pub const ENUM_MIN: u8 = 0;
  pub const ENUM_MAX: u8 = 21;
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::NONE,
    Self::StablehloConcatenateOptions,
    Self::StablehloBroadcastInDimOptions,
    Self::StablehloSliceOptions,
    Self::StablehloConvolutionOptions,
    Self::StablehloCustomCallOptions,
    Self::StablehloReduceOptions,
    Self::StablehloScatterOptions,
    Self::StablehloCompareOptions,
    Self::StablehloDynamicSliceOptions,
    Self::StablehloPadOptions,
    Self::StablehloIotaOptions,
    Self::StablehloDotGeneralOptions,
    Self::StablehloReduceWindowOptions,
    Self::StablehloSortOptions,
    Self::StablehloWhileOptions,
    Self::StablehloGatherOptions,
    Self::StablehloTransposeOptions,
    Self::DilateOptions,
    Self::StablehloRngBitGeneratorOptions,
    Self::ReduceWindowOptions,
    Self::StableHLOCompositeOptions,
  ];
  /// Returns the variant's name or "" if unknown.
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      Self::NONE => Some("NONE"),
      Self::StablehloConcatenateOptions => Some("StablehloConcatenateOptions"),
      Self::StablehloBroadcastInDimOptions => Some("StablehloBroadcastInDimOptions"),
      Self::StablehloSliceOptions => Some("StablehloSliceOptions"),
      Self::StablehloConvolutionOptions => Some("StablehloConvolutionOptions"),
      Self::StablehloCustomCallOptions => Some("StablehloCustomCallOptions"),
      Self::StablehloReduceOptions => Some("StablehloReduceOptions"),
      Self::StablehloScatterOptions => Some("StablehloScatterOptions"),
      Self::StablehloCompareOptions => Some("StablehloCompareOptions"),
      Self::StablehloDynamicSliceOptions => Some("StablehloDynamicSliceOptions"),
      Self::StablehloPadOptions => Some("StablehloPadOptions"),
      Self::StablehloIotaOptions => Some("StablehloIotaOptions"),
      Self::StablehloDotGeneralOptions => Some("StablehloDotGeneralOptions"),
      Self::StablehloReduceWindowOptions => Some("StablehloReduceWindowOptions"),
      Self::StablehloSortOptions => Some("StablehloSortOptions"),
      Self::StablehloWhileOptions => Some("StablehloWhileOptions"),
      Self::StablehloGatherOptions => Some("StablehloGatherOptions"),
      Self::StablehloTransposeOptions => Some("StablehloTransposeOptions"),
      Self::DilateOptions => Some("DilateOptions"),
      Self::StablehloRngBitGeneratorOptions => Some("StablehloRngBitGeneratorOptions"),
      Self::ReduceWindowOptions => Some("ReduceWindowOptions"),
      Self::StableHLOCompositeOptions => Some("StableHLOCompositeOptions"),
      _ => None,
    }
  }
}
impl core::fmt::Debug for BuiltinOptions2 {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for BuiltinOptions2 {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = flatbuffers::read_scalar_at::<u8>(buf, loc);
...
impl flatbuffers::Push for BuiltinOptions2 {
    type Output = BuiltinOptions2;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        flatbuffers::emplace_scalar::<u8>(dst, self.0);
    }
...
impl flatbuffers::EndianScalar for BuiltinOptions2 {
  type Scalar = u8;
  #[inline]
  fn to_little_endian(self) -> u8 {
    self.0.to_le()
...
impl<'a> flatbuffers::Verifiable for BuiltinOptions2 {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_STABLEHLO_PRECISION_CONFIG: u32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_STABLEHLO_PRECISION_CONFIG: u32 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_STABLEHLO_PRECISION_CONFIG: [StablehloPrecisionConfig; 3] = [
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct StablehloPrecisionConfig(pub u32);
#[allow(non_upper_case_globals)]
impl StablehloPrecisionConfig {
  pub const DEFAULT: Self = Self(0);
  pub const HIGH: Self = Self(1);
  pub const HIGHEST: Self = Self(2);
...
impl core::fmt::Debug for StablehloPrecisionConfig {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for StablehloPrecisionConfig {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
...
impl flatbuffers::Push for StablehloPrecisionConfig {
    type Output = StablehloPrecisionConfig;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
...
impl flatbuffers::EndianScalar for StablehloPrecisionConfig {
  type Scalar = u32;
  #[inline]
...
impl<'a> flatbuffers::Verifiable for StablehloPrecisionConfig {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl flatbuffers::SimpleToVerifyInSlice for StablehloPrecisionConfig {}
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_STABLEHLO_COMPARISON_DIRECTION: u32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_STABLEHLO_COMPARISON_DIRECTION: u32 = 5;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_STABLEHLO_COMPARISON_DIRECTION: [StablehloComparisonDirection; 6] = [
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct StablehloComparisonDirection(pub u32);
#[allow(non_upper_case_globals)]
impl StablehloComparisonDirection {
  pub const STABLEHLO_COMPARISON_DIRECTION_EQ: Self = Self(0);
  pub const STABLEHLO_COMPARISON_DIRECTION_NE: Self = Self(1);
  pub const STABLEHLO_COMPARISON_DIRECTION_GE: Self = Self(2);
  pub const STABLEHLO_COMPARISON_DIRECTION_GT: Self = Self(3);
  pub const STABLEHLO_COMPARISON_DIRECTION_LE: Self = Self(4);
  pub const STABLEHLO_COMPARISON_DIRECTION_LT: Self = Self(5);

  pub const ENUM_MIN: u32 = 0;
  pub const ENUM_MAX: u32 = 5;
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::STABLEHLO_COMPARISON_DIRECTION_EQ,
    Self::STABLEHLO_COMPARISON_DIRECTION_NE,
    Self::STABLEHLO_COMPARISON_DIRECTION_GE,
    Self::STABLEHLO_COMPARISON_DIRECTION_GT,
    Self::STABLEHLO_COMPARISON_DIRECTION_LE,
    Self::STABLEHLO_COMPARISON_DIRECTION_LT,
  ];
  /// Returns the variant's name or "" if unknown.
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      Self::STABLEHLO_COMPARISON_DIRECTION_EQ => Some("STABLEHLO_COMPARISON_DIRECTION_EQ"),
      Self::STABLEHLO_COMPARISON_DIRECTION_NE => Some("STABLEHLO_COMPARISON_DIRECTION_NE"),
      Self::STABLEHLO_COMPARISON_DIRECTION_GE => Some("STABLEHLO_COMPARISON_DIRECTION_GE"),
      Self::STABLEHLO_COMPARISON_DIRECTION_GT => Some("STABLEHLO_COMPARISON_DIRECTION_GT"),
      Self::STABLEHLO_COMPARISON_DIRECTION_LE => Some("STABLEHLO_COMPARISON_DIRECTION_LE"),
      Self::STABLEHLO_COMPARISON_DIRECTION_LT => Some("STABLEHLO_COMPARISON_DIRECTION_LT"),
      _ => None,
    }
  }
}
impl core::fmt::Debug for StablehloComparisonDirection {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for StablehloComparisonDirection {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = flatbuffers::read_scalar_at::<u32>(buf, loc);
...
impl flatbuffers::Push for StablehloComparisonDirection {
    type Output = StablehloComparisonDirection;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        flatbuffers::emplace_scalar::<u32>(dst, self.0);
    }
...
impl flatbuffers::EndianScalar for StablehloComparisonDirection {
  type Scalar = u32;
  #[inline]
  fn to_little_endian(self) -> u32 {
    self.0.to_le()
...
impl<'a> flatbuffers::Verifiable for StablehloComparisonDirection {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl flatbuffers::SimpleToVerifyInSlice for StablehloComparisonDirection {}
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_STABLEHLO_COMPARISON_TYPE: u32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_STABLEHLO_COMPARISON_TYPE: u32 = 4;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_STABLEHLO_COMPARISON_TYPE: [StablehloComparisonType; 5] = [
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct StablehloComparisonType(pub u32);
#[allow(non_upper_case_globals)]
impl StablehloComparisonType {
  pub const STABLEHLO_COMPARISON_TYPE_NOTYPE: Self = Self(0);
  pub const STABLEHLO_COMPARISON_TYPE_FLOAT: Self = Self(1);
  pub const STABLEHLO_COMPARISON_TYPE_FLOAT_TOTAL_ORDER: Self = Self(2);
  pub const STABLEHLO_COMPARISON_TYPE_SIGNED: Self = Self(3);
  pub const STABLEHLO_COMPARISON_TYPE_UNSIGNED: Self = Self(4);

  pub const ENUM_MIN: u32 = 0;
  pub const ENUM_MAX: u32 = 4;
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::STABLEHLO_COMPARISON_TYPE_NOTYPE,
    Self::STABLEHLO_COMPARISON_TYPE_FLOAT,
    Self::STABLEHLO_COMPARISON_TYPE_FLOAT_TOTAL_ORDER,
    Self::STABLEHLO_COMPARISON_TYPE_SIGNED,
    Self::STABLEHLO_COMPARISON_TYPE_UNSIGNED,
  ];
  /// Returns the variant's name or "" if unknown.
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      Self::STABLEHLO_COMPARISON_TYPE_NOTYPE => Some("STABLEHLO_COMPARISON_TYPE_NOTYPE"),
      Self::STABLEHLO_COMPARISON_TYPE_FLOAT => Some("STABLEHLO_COMPARISON_TYPE_FLOAT"),
      Self::STABLEHLO_COMPARISON_TYPE_FLOAT_TOTAL_ORDER => Some("STABLEHLO_COMPARISON_TYPE_FLOAT_TOTAL_ORDER"),
      Self::STABLEHLO_COMPARISON_TYPE_SIGNED => Some("STABLEHLO_COMPARISON_TYPE_SIGNED"),
      Self::STABLEHLO_COMPARISON_TYPE_UNSIGNED => Some("STABLEHLO_COMPARISON_TYPE_UNSIGNED"),
      _ => None,
    }
  }
}
impl core::fmt::Debug for StablehloComparisonType {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for StablehloComparisonType {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = flatbuffers::read_scalar_at::<u32>(buf, loc);
...
impl flatbuffers::Push for StablehloComparisonType {
    type Output = StablehloComparisonType;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        flatbuffers::emplace_scalar::<u32>(dst, self.0);
    }
...
impl flatbuffers::EndianScalar for StablehloComparisonType {
  type Scalar = u32;
  #[inline]
  fn to_little_endian(self) -> u32 {
    self.0.to_le()
...
impl<'a> flatbuffers::Verifiable for StablehloComparisonType {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl flatbuffers::SimpleToVerifyInSlice for StablehloComparisonType {}
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_RNG_ALGORITHM: i8 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_RNG_ALGORITHM: i8 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_RNG_ALGORITHM: [RngAlgorithm; 3] = [
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct RngAlgorithm(pub i8);
#[allow(non_upper_case_globals)]
impl RngAlgorithm {
  pub const DEFAULT: Self = Self(0);
  pub const PHILOX: Self = Self(1);
  pub const THREEFRY: Self = Self(2);
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      Self::DEFAULT => Some("DEFAULT"),
      Self::PHILOX => Some("PHILOX"),
      Self::THREEFRY => Some("THREEFRY"),
      _ => None,
    }
  }
}
impl core::fmt::Debug for RngAlgorithm {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for RngAlgorithm {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = flatbuffers::read_scalar_at::<i8>(buf, loc);
...
impl flatbuffers::Push for RngAlgorithm {
    type Output = RngAlgorithm;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        flatbuffers::emplace_scalar::<i8>(dst, self.0);
    }
...
impl flatbuffers::EndianScalar for RngAlgorithm {
  type Scalar = i8;
  #[inline]
  fn to_little_endian(self) -> i8 {
    self.0.to_le()
...
impl<'a> flatbuffers::Verifiable for RngAlgorithm {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl flatbuffers::SimpleToVerifyInSlice for RngAlgorithm {}
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_REDUCE_WINDOW_FUNCTION: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_REDUCE_WINDOW_FUNCTION: i32 = 6;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_REDUCE_WINDOW_FUNCTION: [ReduceWindowFunction; 7] = [
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct ReduceWindowFunction(pub i32);
#[allow(non_upper_case_globals)]
impl ReduceWindowFunction {
...
impl core::fmt::Debug for ReduceWindowFunction {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for ReduceWindowFunction {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = flatbuffers::read_scalar_at::<i32>(buf, loc);
...
impl flatbuffers::Push for ReduceWindowFunction {
    type Output = ReduceWindowFunction;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        flatbuffers::emplace_scalar::<i32>(dst, self.0);
    }
...
impl flatbuffers::EndianScalar for ReduceWindowFunction {
  type Scalar = i32;
  #[inline]
  fn to_little_endian(self) -> i32 {
    self.0.to_le()
...
impl<'a> flatbuffers::Verifiable for ReduceWindowFunction {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl flatbuffers::SimpleToVerifyInSlice for ReduceWindowFunction {}
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
...
pub struct StablehloGatherOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloGatherOptions<'a> {
  type Inner = StablehloGatherOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloGatherOptions<'a> {
  pub const VT_OFFSET_DIMS: flatbuffers::VOffsetT = 4;
  pub const VT_COLLAPSED_SLICE_DIMS: flatbuffers::VOffsetT = 6;
  pub const VT_START_INDEX_MAP: flatbuffers::VOffsetT = 8;
  pub const VT_INDEX_VECTOR_DIM: flatbuffers::VOffsetT = 10;
  pub const VT_SLICE_SIZES: flatbuffers::VOffsetT = 12;
  pub const VT_INDICES_ARE_SORTED: flatbuffers::VOffsetT = 14;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloGatherOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloGatherOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloGatherOptions<'bldr>> {
    let mut builder = StablehloGatherOptionsBuilder::new(_fbb);
    builder.add_index_vector_dim(args.index_vector_dim);
    if let Some(x) = args.slice_sizes { builder.add_slice_sizes(x); }
    if let Some(x) = args.start_index_map { builder.add_start_index_map(x); }
    if let Some(x) = args.collapsed_slice_dims { builder.add_collapsed_slice_dims(x); }
    if let Some(x) = args.offset_dims { builder.add_offset_dims(x); }
  ...
  #[inline]
  pub fn offset_dims(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloGatherOptions::VT_OFFSET_DIMS, None)}
  }
  #[inline]
  pub fn collapsed_slice_dims(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloGatherOptions::VT_COLLAPSED_SLICE_DIMS, None)}
  }
  #[inline]
  pub fn start_index_map(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloGatherOptions::VT_START_INDEX_MAP, None)}
  }
  #[inline]
  pub fn index_vector_dim(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloGatherOptions::VT_INDEX_VECTOR_DIM, Some(0)).unwrap()}
  }
  #[inline]
  pub fn slice_sizes(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloGatherOptions::VT_SLICE_SIZES, None)}
  }
  #[inline]
  pub fn indices_are_sorted(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StablehloGatherOptions::VT_INDICES_ARE_SORTED, Some(false)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloGatherOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("offset_dims", Self::VT_OFFSET_DIMS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("collapsed_slice_dims", Self::VT_COLLAPSED_SLICE_DIMS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("start_index_map", Self::VT_START_INDEX_MAP, false)?
     .visit_field::<i64>("index_vector_dim", Self::VT_INDEX_VECTOR_DIM, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("slice_sizes", Self::VT_SLICE_SIZES, false)?
     .visit_field::<bool>("indices_are_sorted", Self::VT_INDICES_ARE_SORTED, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloGatherOptionsArgs<'a> {
    pub offset_dims: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub collapsed_slice_dims: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub start_index_map: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub index_vector_dim: i64,
    pub slice_sizes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub indices_are_sorted: bool,
}
impl<'a> Default for StablehloGatherOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloGatherOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloGatherOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_offset_dims(&mut self, offset_dims: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloGatherOptions::VT_OFFSET_DIMS, offset_dims);
  }
  #[inline]
  pub fn add_collapsed_slice_dims(&mut self, collapsed_slice_dims: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloGatherOptions::VT_COLLAPSED_SLICE_DIMS, collapsed_slice_dims);
  }
  #[inline]
  pub fn add_start_index_map(&mut self, start_index_map: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloGatherOptions::VT_START_INDEX_MAP, start_index_map);
  }
  #[inline]
  pub fn add_index_vector_dim(&mut self, index_vector_dim: i64) {
    self.fbb_.push_slot::<i64>(StablehloGatherOptions::VT_INDEX_VECTOR_DIM, index_vector_dim, 0);
  }
  #[inline]
  pub fn add_slice_sizes(&mut self, slice_sizes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloGatherOptions::VT_SLICE_SIZES, slice_sizes);
  }
  #[inline]
  pub fn add_indices_are_sorted(&mut self, indices_are_sorted: bool) {
    self.fbb_.push_slot::<bool>(StablehloGatherOptions::VT_INDICES_ARE_SORTED, indices_are_sorted, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloGatherOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloGatherOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloGatherOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloGatherOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloGatherOptions");
      ds.field("offset_dims", &self.offset_dims());
      ds.field("collapsed_slice_dims", &self.collapsed_slice_dims());
      ds.field("start_index_map", &self.start_index_map());
      ds.field("index_vector_dim", &self.index_vector_dim());
      ds.field("slice_sizes", &self.slice_sizes());
      ds.field("indices_are_sorted", &self.indices_are_sorted());
      ds.finish()
  }
}
...
pub struct StablehloTransposeOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloTransposeOptions<'a> {
  type Inner = StablehloTransposeOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloTransposeOptions<'a> {
  pub const VT_PERMUTATION: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloTransposeOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloTransposeOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloTransposeOptions<'bldr>> {
    let mut builder = StablehloTransposeOptionsBuilder::new(_fbb);
    if let Some(x) = args.permutation { builder.add_permutation(x); }
    builder.finish()
  }


  #[inline]
  pub fn permutation(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloTransposeOptions::VT_PERMUTATION, None)}
  }
}

impl flatbuffers::Verifiable for StablehloTransposeOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("permutation", Self::VT_PERMUTATION, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloTransposeOptionsArgs<'a> {
    pub permutation: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
}
impl<'a> Default for StablehloTransposeOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
    StablehloTransposeOptionsArgs {
      permutation: None,
    }
  }
}

pub struct StablehloTransposeOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloTransposeOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_permutation(&mut self, permutation: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloTransposeOptions::VT_PERMUTATION, permutation);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloTransposeOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloTransposeOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloTransposeOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloTransposeOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloTransposeOptions");
      ds.field("permutation", &self.permutation());
      ds.finish()
  }
}
...
pub struct StablehloDotGeneralOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloDotGeneralOptions<'a> {
  type Inner = StablehloDotGeneralOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloDotGeneralOptions<'a> {
  pub const VT_LHS_BATCHING_DIMENSIONS: flatbuffers::VOffsetT = 4;
  pub const VT_RHS_BATCHING_DIMENSIONS: flatbuffers::VOffsetT = 6;
  pub const VT_LHS_CONTRACTING_DIMENSIONS: flatbuffers::VOffsetT = 8;
  pub const VT_RHS_CONTRACTING_DIMENSIONS: flatbuffers::VOffsetT = 10;
  pub const VT_PRECISION_CONFIG: flatbuffers::VOffsetT = 12;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloDotGeneralOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloDotGeneralOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloDotGeneralOptions<'bldr>> {
    let mut builder = StablehloDotGeneralOptionsBuilder::new(_fbb);
    if let Some(x) = args.precision_config { builder.add_precision_config(x); }
    if let Some(x) = args.rhs_contracting_dimensions { builder.add_rhs_contracting_dimensions(x); }
    if let Some(x) = args.lhs_contracting_dimensions { builder.add_lhs_contracting_dimensions(x); }
    if let Some(x) = args.rhs_batching_dimensions { builder.add_rhs_batching_dimensions(x); }
    if let Some(x) = args.lhs_batching_dimensions { builder.add_lhs_batching_dimensions(x); }
    builder.finish()
  }


  #[inline]
  pub fn lhs_batching_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloDotGeneralOptions::VT_LHS_BATCHING_DIMENSIONS, None)}
  }
  #[inline]
  pub fn rhs_batching_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloDotGeneralOptions::VT_RHS_BATCHING_DIMENSIONS, None)}
  }
  #[inline]
  pub fn lhs_contracting_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloDotGeneralOptions::VT_LHS_CONTRACTING_DIMENSIONS, None)}
  }
  #[inline]
  pub fn rhs_contracting_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloDotGeneralOptions::VT_RHS_CONTRACTING_DIMENSIONS, None)}
  }
  #[inline]
  pub fn precision_config(&self) -> Option<flatbuffers::Vector<'a, StablehloPrecisionConfig>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, StablehloPrecisionConfig>>>(StablehloDotGeneralOptions::VT_PRECISION_CONFIG, None)}
  }
}

impl flatbuffers::Verifiable for StablehloDotGeneralOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("lhs_batching_dimensions", Self::VT_LHS_BATCHING_DIMENSIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("rhs_batching_dimensions", Self::VT_RHS_BATCHING_DIMENSIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("lhs_contracting_dimensions", Self::VT_LHS_CONTRACTING_DIMENSIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("rhs_contracting_dimensions", Self::VT_RHS_CONTRACTING_DIMENSIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, StablehloPrecisionConfig>>>("precision_config", Self::VT_PRECISION_CONFIG, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloDotGeneralOptionsArgs<'a> {
    pub lhs_batching_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub rhs_batching_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub lhs_contracting_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub rhs_contracting_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub precision_config: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, StablehloPrecisionConfig>>>,
}
impl<'a> Default for StablehloDotGeneralOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloDotGeneralOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloDotGeneralOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_lhs_batching_dimensions(&mut self, lhs_batching_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloDotGeneralOptions::VT_LHS_BATCHING_DIMENSIONS, lhs_batching_dimensions);
  }
  #[inline]
  pub fn add_rhs_batching_dimensions(&mut self, rhs_batching_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloDotGeneralOptions::VT_RHS_BATCHING_DIMENSIONS, rhs_batching_dimensions);
  }
  #[inline]
  pub fn add_lhs_contracting_dimensions(&mut self, lhs_contracting_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloDotGeneralOptions::VT_LHS_CONTRACTING_DIMENSIONS, lhs_contracting_dimensions);
  }
  #[inline]
  pub fn add_rhs_contracting_dimensions(&mut self, rhs_contracting_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloDotGeneralOptions::VT_RHS_CONTRACTING_DIMENSIONS, rhs_contracting_dimensions);
  }
  #[inline]
  pub fn add_precision_config(&mut self, precision_config: flatbuffers::WIPOffset<flatbuffers::Vector<'b , StablehloPrecisionConfig>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloDotGeneralOptions::VT_PRECISION_CONFIG, precision_config);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloDotGeneralOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloDotGeneralOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloDotGeneralOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloDotGeneralOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloDotGeneralOptions");
      ds.field("lhs_batching_dimensions", &self.lhs_batching_dimensions());
      ds.field("rhs_batching_dimensions", &self.rhs_batching_dimensions());
      ds.field("lhs_contracting_dimensions", &self.lhs_contracting_dimensions());
      ds.field("rhs_contracting_dimensions", &self.rhs_contracting_dimensions());
      ds.field("precision_config", &self.precision_config());
      ds.finish()
  }
}
...
pub struct StablehloReduceWindowOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloReduceWindowOptions<'a> {
  type Inner = StablehloReduceWindowOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloReduceWindowOptions<'a> {
  pub const VT_WINDOW_DIMENSIONS: flatbuffers::VOffsetT = 4;
  pub const VT_WINDOW_STRIDES: flatbuffers::VOffsetT = 6;
  pub const VT_BASE_DILATIONS: flatbuffers::VOffsetT = 8;
  pub const VT_WINDOW_DILATIONS: flatbuffers::VOffsetT = 10;
  pub const VT_PADDING: flatbuffers::VOffsetT = 12;
  pub const VT_BODY_SUBGRAPH_INDEX: flatbuffers::VOffsetT = 14;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloReduceWindowOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloReduceWindowOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloReduceWindowOptions<'bldr>> {
    let mut builder = StablehloReduceWindowOptionsBuilder::new(_fbb);
    builder.add_body_subgraph_index(args.body_subgraph_index);
    if let Some(x) = args.padding { builder.add_padding(x); }
    if let Some(x) = args.window_dilations { builder.add_window_dilations(x); }
    if let Some(x) = args.base_dilations { builder.add_base_dilations(x); }
    if let Some(x) = args.window_strides { builder.add_window_strides(x); }
    if let Some(x) = args.window_dimensions { builder.add_window_dimensions(x); }
    builder.finish()
  }


  #[inline]
  pub fn window_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloReduceWindowOptions::VT_WINDOW_DIMENSIONS, None)}
  }
  #[inline]
  pub fn window_strides(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloReduceWindowOptions::VT_WINDOW_STRIDES, None)}
  }
  #[inline]
  pub fn base_dilations(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloReduceWindowOptions::VT_BASE_DILATIONS, None)}
  }
  #[inline]
  pub fn window_dilations(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloReduceWindowOptions::VT_WINDOW_DILATIONS, None)}
  }
  #[inline]
  pub fn padding(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloReduceWindowOptions::VT_PADDING, None)}
  }
  #[inline]
  pub fn body_subgraph_index(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StablehloReduceWindowOptions::VT_BODY_SUBGRAPH_INDEX, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloReduceWindowOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("window_dimensions", Self::VT_WINDOW_DIMENSIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("window_strides", Self::VT_WINDOW_STRIDES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("base_dilations", Self::VT_BASE_DILATIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("window_dilations", Self::VT_WINDOW_DILATIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("padding", Self::VT_PADDING, false)?
     .visit_field::<i32>("body_subgraph_index", Self::VT_BODY_SUBGRAPH_INDEX, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloReduceWindowOptionsArgs<'a> {
    pub window_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub window_strides: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub base_dilations: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub window_dilations: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub padding: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub body_subgraph_index: i32,
}
impl<'a> Default for StablehloReduceWindowOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloReduceWindowOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloReduceWindowOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_window_dimensions(&mut self, window_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloReduceWindowOptions::VT_WINDOW_DIMENSIONS, window_dimensions);
  }
  #[inline]
  pub fn add_window_strides(&mut self, window_strides: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloReduceWindowOptions::VT_WINDOW_STRIDES, window_strides);
  }
  #[inline]
  pub fn add_base_dilations(&mut self, base_dilations: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloReduceWindowOptions::VT_BASE_DILATIONS, base_dilations);
  }
  #[inline]
  pub fn add_window_dilations(&mut self, window_dilations: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloReduceWindowOptions::VT_WINDOW_DILATIONS, window_dilations);
  }
  #[inline]
  pub fn add_padding(&mut self, padding: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloReduceWindowOptions::VT_PADDING, padding);
  }
  #[inline]
  pub fn add_body_subgraph_index(&mut self, body_subgraph_index: i32) {
    self.fbb_.push_slot::<i32>(StablehloReduceWindowOptions::VT_BODY_SUBGRAPH_INDEX, body_subgraph_index, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloReduceWindowOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloReduceWindowOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloReduceWindowOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloReduceWindowOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloReduceWindowOptions");
      ds.field("window_dimensions", &self.window_dimensions());
      ds.field("window_strides", &self.window_strides());
      ds.field("base_dilations", &self.base_dilations());
      ds.field("window_dilations", &self.window_dilations());
...
pub struct StablehloWhileOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloWhileOptions<'a> {
  type Inner = StablehloWhileOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloWhileOptions<'a> {
  pub const VT_COND_SUBGRAPH_INDEX: flatbuffers::VOffsetT = 4;
  pub const VT_BODY_SUBGRAPH_INDEX: flatbuffers::VOffsetT = 6;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloWhileOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloWhileOptionsArgs
  ) -> flatbuffers::WIPOffset<StablehloWhileOptions<'bldr>> {
    let mut builder = StablehloWhileOptionsBuilder::new(_fbb);
    builder.add_body_subgraph_index(args.body_subgraph_index);
  ...
  pub fn cond_subgraph_index(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StablehloWhileOptions::VT_COND_SUBGRAPH_INDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn body_subgraph_index(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StablehloWhileOptions::VT_BODY_SUBGRAPH_INDEX, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloWhileOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct StablehloWhileOptionsArgs {
    pub cond_subgraph_index: i32,
    pub body_subgraph_index: i32,
}
impl<'a> Default for StablehloWhileOptionsArgs {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloWhileOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloWhileOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_cond_subgraph_index(&mut self, cond_subgraph_index: i32) {
    self.fbb_.push_slot::<i32>(StablehloWhileOptions::VT_COND_SUBGRAPH_INDEX, cond_subgraph_index, 0);
  }
  #[inline]
  pub fn add_body_subgraph_index(&mut self, body_subgraph_index: i32) {
    self.fbb_.push_slot::<i32>(StablehloWhileOptions::VT_BODY_SUBGRAPH_INDEX, body_subgraph_index, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloWhileOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloWhileOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloWhileOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloWhileOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloWhileOptions");
...
pub struct StablehloSortOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloSortOptions<'a> {
  type Inner = StablehloSortOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloSortOptions<'a> {
  pub const VT_DIMENSION: flatbuffers::VOffsetT = 4;
  pub const VT_IS_STABLE: flatbuffers::VOffsetT = 6;
  pub const VT_COMPARATOR_SUBGRAPH_INDEX: flatbuffers::VOffsetT = 8;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloSortOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloSortOptionsArgs
  ) -> flatbuffers::WIPOffset<StablehloSortOptions<'bldr>> {
    let mut builder = StablehloSortOptionsBuilder::new(_fbb);
  ...
  pub fn dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloSortOptions::VT_DIMENSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn is_stable(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StablehloSortOptions::VT_IS_STABLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn comparator_subgraph_index(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StablehloSortOptions::VT_COMPARATOR_SUBGRAPH_INDEX, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloSortOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<i64>("dimension", Self::VT_DIMENSION, false)?
     .visit_field::<bool>("is_stable", Self::VT_IS_STABLE, false)?
     .visit_field::<i32>("comparator_subgraph_index", Self::VT_COMPARATOR_SUBGRAPH_INDEX, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloSortOptionsArgs {
    pub dimension: i64,
    pub is_stable: bool,
    pub comparator_subgraph_index: i32,
}
impl<'a> Default for StablehloSortOptionsArgs {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloSortOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloSortOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_dimension(&mut self, dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloSortOptions::VT_DIMENSION, dimension, 0);
  }
  #[inline]
  pub fn add_is_stable(&mut self, is_stable: bool) {
    self.fbb_.push_slot::<bool>(StablehloSortOptions::VT_IS_STABLE, is_stable, false);
  }
  #[inline]
  pub fn add_comparator_subgraph_index(&mut self, comparator_subgraph_index: i32) {
    self.fbb_.push_slot::<i32>(StablehloSortOptions::VT_COMPARATOR_SUBGRAPH_INDEX, comparator_subgraph_index, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloSortOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloSortOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloSortOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloSortOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloSortOptions");
      ds.field("dimension", &self.dimension());
      ds.field("is_stable", &self.is_stable());
      ds.field("comparator_subgraph_index", &self.comparator_subgraph_index());
      ds.finish()
  }
}
...
pub struct StablehloConcatenateOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloConcatenateOptions<'a> {
  type Inner = StablehloConcatenateOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloConcatenateOptions<'a> {
  pub const VT_DIMENSION: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloConcatenateOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloConcatenateOptionsArgs
  ) -> flatbuffers::WIPOffset<StablehloConcatenateOptions<'bldr>> {
  ...
  pub fn dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConcatenateOptions::VT_DIMENSION, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloConcatenateOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct StablehloConcatenateOptionsArgs {
    pub dimension: i64,
}
impl<'a> Default for StablehloConcatenateOptionsArgs {
  #[inline]
  fn default() -> Self {
    StablehloConcatenateOptionsArgs {
      dimension: 0,
    }
  }
}

pub struct StablehloConcatenateOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloConcatenateOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_dimension(&mut self, dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloConcatenateOptions::VT_DIMENSION, dimension, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloConcatenateOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloConcatenateOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloConcatenateOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloConcatenateOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloConcatenateOptions");
      ds.field("dimension", &self.dimension());
      ds.finish()
  }
}
...
pub struct StablehloBroadcastInDimOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloBroadcastInDimOptions<'a> {
  type Inner = StablehloBroadcastInDimOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloBroadcastInDimOptions<'a> {
  pub const VT_BROADCAST_DIMENSIONS: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloBroadcastInDimOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloBroadcastInDimOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloBroadcastInDimOptions<'bldr>> {
    let mut builder = StablehloBroadcastInDimOptionsBuilder::new(_fbb);
    if let Some(x) = args.broadcast_dimensions { builder.add_broadcast_dimensions(x); }
    builder.finish()
  }


  #[inline]
  pub fn broadcast_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloBroadcastInDimOptions::VT_BROADCAST_DIMENSIONS, None)}
  }
}

impl flatbuffers::Verifiable for StablehloBroadcastInDimOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("broadcast_dimensions", Self::VT_BROADCAST_DIMENSIONS, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloBroadcastInDimOptionsArgs<'a> {
    pub broadcast_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
}
impl<'a> Default for StablehloBroadcastInDimOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloBroadcastInDimOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloBroadcastInDimOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_broadcast_dimensions(&mut self, broadcast_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloBroadcastInDimOptions::VT_BROADCAST_DIMENSIONS, broadcast_dimensions);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloBroadcastInDimOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloBroadcastInDimOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloBroadcastInDimOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloBroadcastInDimOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloBroadcastInDimOptions");
      ds.field("broadcast_dimensions", &self.broadcast_dimensions());
      ds.finish()
  }
}
...
pub struct StablehloCompareOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloCompareOptions<'a> {
  type Inner = StablehloCompareOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloCompareOptions<'a> {
  pub const VT_COMPARISON_DIRECTION: flatbuffers::VOffsetT = 4;
  pub const VT_COMPARE_TYPE: flatbuffers::VOffsetT = 6;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloCompareOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloCompareOptionsArgs
  ) -> flatbuffers::WIPOffset<StablehloCompareOptions<'bldr>> {
    let mut builder = StablehloCompareOptionsBuilder::new(_fbb);
  ...
  #[inline]
  pub fn comparison_direction(&self) -> StablehloComparisonDirection {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<StablehloComparisonDirection>(StablehloCompareOptions::VT_COMPARISON_DIRECTION, Some(StablehloComparisonDirection::STABLEHLO_COMPARISON_DIRECTION_EQ)).unwrap()}
  }
  #[inline]
  pub fn compare_type(&self) -> StablehloComparisonType {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<StablehloComparisonType>(StablehloCompareOptions::VT_COMPARE_TYPE, Some(StablehloComparisonType::STABLEHLO_COMPARISON_TYPE_NOTYPE)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloCompareOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<StablehloComparisonDirection>("comparison_direction", Self::VT_COMPARISON_DIRECTION, false)?
     .visit_field::<StablehloComparisonType>("compare_type", Self::VT_COMPARE_TYPE, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloCompareOptionsArgs {
    pub comparison_direction: StablehloComparisonDirection,
    pub compare_type: StablehloComparisonType,
}
impl<'a> Default for StablehloCompareOptionsArgs {
  #[inline]
  fn default() -> Self {
    StablehloCompareOptionsArgs {
      comparison_direction: StablehloComparisonDirection::STABLEHLO_COMPARISON_DIRECTION_EQ,
      compare_type: StablehloComparisonType::STABLEHLO_COMPARISON_TYPE_NOTYPE,
    }
  }
}

pub struct StablehloCompareOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloCompareOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_comparison_direction(&mut self, comparison_direction: StablehloComparisonDirection) {
    self.fbb_.push_slot::<StablehloComparisonDirection>(StablehloCompareOptions::VT_COMPARISON_DIRECTION, comparison_direction, StablehloComparisonDirection::STABLEHLO_COMPARISON_DIRECTION_EQ);
  }
  #[inline]
  pub fn add_compare_type(&mut self, compare_type: StablehloComparisonType) {
    self.fbb_.push_slot::<StablehloComparisonType>(StablehloCompareOptions::VT_COMPARE_TYPE, compare_type, StablehloComparisonType::STABLEHLO_COMPARISON_TYPE_NOTYPE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloCompareOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloCompareOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloCompareOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloCompareOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloCompareOptions");
      ds.field("comparison_direction", &self.comparison_direction());
      ds.field("compare_type", &self.compare_type());
      ds.finish()
  }
}
...
pub struct StablehloDynamicSliceOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloDynamicSliceOptions<'a> {
  type Inner = StablehloDynamicSliceOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloDynamicSliceOptions<'a> {
  pub const VT_SLICE_SIZES: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloDynamicSliceOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloDynamicSliceOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloDynamicSliceOptions<'bldr>> {
    let mut builder = StablehloDynamicSliceOptionsBuilder::new(_fbb);
    if let Some(x) = args.slice_sizes { builder.add_slice_sizes(x); }
    builder.finish()
  }
  ...
  pub fn slice_sizes(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloDynamicSliceOptions::VT_SLICE_SIZES, None)}
  }
}

impl flatbuffers::Verifiable for StablehloDynamicSliceOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct StablehloDynamicSliceOptionsArgs<'a> {
    pub slice_sizes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
}
impl<'a> Default for StablehloDynamicSliceOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
    StablehloDynamicSliceOptionsArgs {
      slice_sizes: None,
    }
  }
}

pub struct StablehloDynamicSliceOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloDynamicSliceOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_slice_sizes(&mut self, slice_sizes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloDynamicSliceOptions::VT_SLICE_SIZES, slice_sizes);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloDynamicSliceOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloDynamicSliceOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloDynamicSliceOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloDynamicSliceOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloDynamicSliceOptions");
      ds.field("slice_sizes", &self.slice_sizes());
      ds.finish()
  }
}
...
pub struct StablehloPadOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloPadOptions<'a> {
  type Inner = StablehloPadOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloPadOptions<'a> {
  pub const VT_EDGE_PADDING_LOW: flatbuffers::VOffsetT = 4;
  pub const VT_EDGE_PADDING_HIGH: flatbuffers::VOffsetT = 6;
  pub const VT_INTERIOR_PADDING: flatbuffers::VOffsetT = 8;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloPadOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloPadOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloPadOptions<'bldr>> {
    let mut builder = StablehloPadOptionsBuilder::new(_fbb);
    if let Some(x) = args.interior_padding { builder.add_interior_padding(x); }
    if let Some(x) = args.edge_padding_high { builder.add_edge_padding_high(x); }
    if let Some(x) = args.edge_padding_low { builder.add_edge_padding_low(x); }
    builder.finish()
  }


  #[inline]
  pub fn edge_padding_low(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloPadOptions::VT_EDGE_PADDING_LOW, None)}
  }
  #[inline]
  pub fn edge_padding_high(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloPadOptions::VT_EDGE_PADDING_HIGH, None)}
  }
  #[inline]
  pub fn interior_padding(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloPadOptions::VT_INTERIOR_PADDING, None)}
  }
}

impl flatbuffers::Verifiable for StablehloPadOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("edge_padding_low", Self::VT_EDGE_PADDING_LOW, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("edge_padding_high", Self::VT_EDGE_PADDING_HIGH, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("interior_padding", Self::VT_INTERIOR_PADDING, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloPadOptionsArgs<'a> {
    pub edge_padding_low: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub edge_padding_high: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub interior_padding: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
}
impl<'a> Default for StablehloPadOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloPadOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloPadOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_edge_padding_low(&mut self, edge_padding_low: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloPadOptions::VT_EDGE_PADDING_LOW, edge_padding_low);
  }
  #[inline]
  pub fn add_edge_padding_high(&mut self, edge_padding_high: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloPadOptions::VT_EDGE_PADDING_HIGH, edge_padding_high);
  }
  #[inline]
  pub fn add_interior_padding(&mut self, interior_padding: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloPadOptions::VT_INTERIOR_PADDING, interior_padding);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloPadOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloPadOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloPadOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloPadOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloPadOptions");
      ds.field("edge_padding_low", &self.edge_padding_low());
      ds.field("edge_padding_high", &self.edge_padding_high());
      ds.field("interior_padding", &self.interior_padding());
      ds.finish()
  }
}
...
pub struct StablehloIotaOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloIotaOptions<'a> {
  type Inner = StablehloIotaOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloIotaOptions<'a> {
  pub const VT_IOTA_DIMENSION: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloIotaOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloIotaOptionsArgs
  ) -> flatbuffers::WIPOffset<StablehloIotaOptions<'bldr>> {
  ...
  pub fn iota_dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloIotaOptions::VT_IOTA_DIMENSION, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloIotaOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<i64>("iota_dimension", Self::VT_IOTA_DIMENSION, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloIotaOptionsArgs {
    pub iota_dimension: i64,
}
impl<'a> Default for StablehloIotaOptionsArgs {
  #[inline]
  fn default() -> Self {
    StablehloIotaOptionsArgs {
      iota_dimension: 0,
    }
  }
}

pub struct StablehloIotaOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloIotaOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_iota_dimension(&mut self, iota_dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloIotaOptions::VT_IOTA_DIMENSION, iota_dimension, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloIotaOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloIotaOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloIotaOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloIotaOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloIotaOptions");
      ds.field("iota_dimension", &self.iota_dimension());
      ds.finish()
  }
}
...
pub struct StablehloCustomCallOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloCustomCallOptions<'a> {
  type Inner = StablehloCustomCallOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloCustomCallOptions<'a> {
  pub const VT_CALL_TARGET_NAME: flatbuffers::VOffsetT = 4;
  pub const VT_HAS_SIDE_EFFECT: flatbuffers::VOffsetT = 6;
  pub const VT_BACKEND_CONFIG: flatbuffers::VOffsetT = 8;
  pub const VT_API_VERSION: flatbuffers::VOffsetT = 10;
  pub const VT_CALLED_COMPUTATIONS: flatbuffers::VOffsetT = 12;
  pub const VT_CUSTOM_ATTRIBUTES: flatbuffers::VOffsetT = 14;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloCustomCallOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloCustomCallOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloCustomCallOptions<'bldr>> {
    let mut builder = StablehloCustomCallOptionsBuilder::new(_fbb);
    if let Some(x) = args.custom_attributes { builder.add_custom_attributes(x); }
    if let Some(x) = args.called_computations { builder.add_called_computations(x); }
    builder.add_api_version(args.api_version);
    if let Some(x) = args.backend_config { builder.add_backend_config(x); }
    if let Some(x) = args.call_target_name { builder.add_call_target_name(x); }
  ...
  #[inline]
  pub fn call_target_name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(StablehloCustomCallOptions::VT_CALL_TARGET_NAME, None)}
  }
  #[inline]
  pub fn has_side_effect(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StablehloCustomCallOptions::VT_HAS_SIDE_EFFECT, Some(false)).unwrap()}
  }
  #[inline]
  pub fn backend_config(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(StablehloCustomCallOptions::VT_BACKEND_CONFIG, None)}
  }
  #[inline]
  pub fn api_version(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StablehloCustomCallOptions::VT_API_VERSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn called_computations(&self) -> Option<flatbuffers::Vector<'a, i32>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(StablehloCustomCallOptions::VT_CALLED_COMPUTATIONS, None)}
  }
  #[inline]
  pub fn custom_attributes(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StablehloCustomCallOptions::VT_CUSTOM_ATTRIBUTES, None)}
  }
}

impl flatbuffers::Verifiable for StablehloCustomCallOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("call_target_name", Self::VT_CALL_TARGET_NAME, false)?
     .visit_field::<bool>("has_side_effect", Self::VT_HAS_SIDE_EFFECT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("backend_config", Self::VT_BACKEND_CONFIG, false)?
     .visit_field::<i32>("api_version", Self::VT_API_VERSION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i32>>>("called_computations", Self::VT_CALLED_COMPUTATIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("custom_attributes", Self::VT_CUSTOM_ATTRIBUTES, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloCustomCallOptionsArgs<'a> {
    pub call_target_name: Option<flatbuffers::WIPOffset<&'a str>>,
    pub has_side_effect: bool,
    pub backend_config: Option<flatbuffers::WIPOffset<&'a str>>,
    pub api_version: i32,
    pub called_computations: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i32>>>,
    pub custom_attributes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
}
impl<'a> Default for StablehloCustomCallOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloCustomCallOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloCustomCallOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_call_target_name(&mut self, call_target_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloCustomCallOptions::VT_CALL_TARGET_NAME, call_target_name);
  }
  #[inline]
  pub fn add_has_side_effect(&mut self, has_side_effect: bool) {
    self.fbb_.push_slot::<bool>(StablehloCustomCallOptions::VT_HAS_SIDE_EFFECT, has_side_effect, false);
  }
  #[inline]
  pub fn add_backend_config(&mut self, backend_config: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloCustomCallOptions::VT_BACKEND_CONFIG, backend_config);
  }
  #[inline]
  pub fn add_api_version(&mut self, api_version: i32) {
    self.fbb_.push_slot::<i32>(StablehloCustomCallOptions::VT_API_VERSION, api_version, 0);
  }
  #[inline]
  pub fn add_called_computations(&mut self, called_computations: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloCustomCallOptions::VT_CALLED_COMPUTATIONS, called_computations);
  }
  #[inline]
  pub fn add_custom_attributes(&mut self, custom_attributes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloCustomCallOptions::VT_CUSTOM_ATTRIBUTES, custom_attributes);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloCustomCallOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloCustomCallOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloCustomCallOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloCustomCallOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloCustomCallOptions");
      ds.field("call_target_name", &self.call_target_name());
      ds.field("has_side_effect", &self.has_side_effect());
      ds.field("backend_config", &self.backend_config());
      ds.field("api_version", &self.api_version());
      ds.field("called_computations", &self.called_computations());
      ds.field("custom_attributes", &self.custom_attributes());
      ds.finish()
  }
}
...
pub struct StablehloReduceOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloReduceOptions<'a> {
  type Inner = StablehloReduceOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloReduceOptions<'a> {
  pub const VT_DIMENSIONS: flatbuffers::VOffsetT = 4;
  pub const VT_BODY_SUBGRAPH_INDEX: flatbuffers::VOffsetT = 6;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloReduceOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloReduceOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloReduceOptions<'bldr>> {
    let mut builder = StablehloReduceOptionsBuilder::new(_fbb);
    builder.add_body_subgraph_index(args.body_subgraph_index);
  ...
  #[inline]
  pub fn dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloReduceOptions::VT_DIMENSIONS, None)}
  }
  #[inline]
  pub fn body_subgraph_index(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StablehloReduceOptions::VT_BODY_SUBGRAPH_INDEX, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloReduceOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("dimensions", Self::VT_DIMENSIONS, false)?
     .visit_field::<i32>("body_subgraph_index", Self::VT_BODY_SUBGRAPH_INDEX, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloReduceOptionsArgs<'a> {
    pub dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub body_subgraph_index: i32,
}
impl<'a> Default for StablehloReduceOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloReduceOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloReduceOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_dimensions(&mut self, dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloReduceOptions::VT_DIMENSIONS, dimensions);
  }
  #[inline]
  pub fn add_body_subgraph_index(&mut self, body_subgraph_index: i32) {
    self.fbb_.push_slot::<i32>(StablehloReduceOptions::VT_BODY_SUBGRAPH_INDEX, body_subgraph_index, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloReduceOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloReduceOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloReduceOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloReduceOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloReduceOptions");
...
pub struct StablehloSliceOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloSliceOptions<'a> {
  type Inner = StablehloSliceOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloSliceOptions<'a> {
  pub const VT_START_INDICES: flatbuffers::VOffsetT = 4;
  pub const VT_LIMIT_INDICES: flatbuffers::VOffsetT = 6;
  pub const VT_STRIDES: flatbuffers::VOffsetT = 8;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloSliceOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloSliceOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloSliceOptions<'bldr>> {
    let mut builder = StablehloSliceOptionsBuilder::new(_fbb);
    if let Some(x) = args.strides { builder.add_strides(x); }
    if let Some(x) = args.limit_indices { builder.add_limit_indices(x); }
    if let Some(x) = args.start_indices { builder.add_start_indices(x); }
    builder.finish()
  }


  #[inline]
  pub fn start_indices(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloSliceOptions::VT_START_INDICES, None)}
  }
  #[inline]
  pub fn limit_indices(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloSliceOptions::VT_LIMIT_INDICES, None)}
  }
  #[inline]
  pub fn strides(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloSliceOptions::VT_STRIDES, None)}
  }
}

impl flatbuffers::Verifiable for StablehloSliceOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("start_indices", Self::VT_START_INDICES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("limit_indices", Self::VT_LIMIT_INDICES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("strides", Self::VT_STRIDES, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloSliceOptionsArgs<'a> {
    pub start_indices: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub limit_indices: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub strides: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
}
impl<'a> Default for StablehloSliceOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloSliceOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloSliceOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_start_indices(&mut self, start_indices: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloSliceOptions::VT_START_INDICES, start_indices);
  }
  #[inline]
  pub fn add_limit_indices(&mut self, limit_indices: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloSliceOptions::VT_LIMIT_INDICES, limit_indices);
  }
  #[inline]
  pub fn add_strides(&mut self, strides: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloSliceOptions::VT_STRIDES, strides);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloSliceOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloSliceOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloSliceOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloSliceOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloSliceOptions");
      ds.field("start_indices", &self.start_indices());
      ds.field("limit_indices", &self.limit_indices());
...
pub struct StablehloConvolutionOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloConvolutionOptions<'a> {
  type Inner = StablehloConvolutionOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloConvolutionOptions<'a> {
  pub const VT_WINDOW_STRIDES: flatbuffers::VOffsetT = 4;
  pub const VT_PADDING: flatbuffers::VOffsetT = 6;
  pub const VT_LHS_DILATION: flatbuffers::VOffsetT = 8;
  pub const VT_RHS_DILATION: flatbuffers::VOffsetT = 10;
  pub const VT_WINDOW_REVERSAL: flatbuffers::VOffsetT = 12;
  pub const VT_INPUT_BATCH_DIMENSION: flatbuffers::VOffsetT = 14;
  pub const VT_INPUT_FEATURE_DIMENSION: flatbuffers::VOffsetT = 16;
  pub const VT_INPUT_SPATIAL_DIMENSIONS: flatbuffers::VOffsetT = 18;
  pub const VT_KERNEL_INPUT_FEATURE_DIMENSION: flatbuffers::VOffsetT = 20;
  pub const VT_KERNEL_OUTPUT_FEATURE_DIMENSION: flatbuffers::VOffsetT = 22;
  pub const VT_KERNEL_SPATIAL_DIMENSIONS: flatbuffers::VOffsetT = 24;
  pub const VT_OUTPUT_BATCH_DIMENSION: flatbuffers::VOffsetT = 26;
  pub const VT_OUTPUT_FEATURE_DIMENSION: flatbuffers::VOffsetT = 28;
  pub const VT_OUTPUT_SPATIAL_DIMENSIONS: flatbuffers::VOffsetT = 30;
  pub const VT_FEATURE_GROUP_COUNT: flatbuffers::VOffsetT = 32;
  pub const VT_BATCH_GROUP_COUNT: flatbuffers::VOffsetT = 34;
  pub const VT_PRECISION_CONFIG: flatbuffers::VOffsetT = 36;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloConvolutionOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloConvolutionOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloConvolutionOptions<'bldr>> {
    let mut builder = StablehloConvolutionOptionsBuilder::new(_fbb);
    builder.add_batch_group_count(args.batch_group_count);
    builder.add_feature_group_count(args.feature_group_count);
    builder.add_output_feature_dimension(args.output_feature_dimension);
    builder.add_output_batch_dimension(args.output_batch_dimension);
    builder.add_kernel_output_feature_dimension(args.kernel_output_feature_dimension);
    builder.add_kernel_input_feature_dimension(args.kernel_input_feature_dimension);
    builder.add_input_feature_dimension(args.input_feature_dimension);
    builder.add_input_batch_dimension(args.input_batch_dimension);
    if let Some(x) = args.precision_config { builder.add_precision_config(x); }
    if let Some(x) = args.output_spatial_dimensions { builder.add_output_spatial_dimensions(x); }
    if let Some(x) = args.kernel_spatial_dimensions { builder.add_kernel_spatial_dimensions(x); }
    if let Some(x) = args.input_spatial_dimensions { builder.add_input_spatial_dimensions(x); }
    if let Some(x) = args.window_reversal { builder.add_window_reversal(x); }
    if let Some(x) = args.rhs_dilation { builder.add_rhs_dilation(x); }
    if let Some(x) = args.lhs_dilation { builder.add_lhs_dilation(x); }
    if let Some(x) = args.padding { builder.add_padding(x); }
    if let Some(x) = args.window_strides { builder.add_window_strides(x); }
    builder.finish()
  }
  ...
  pub fn window_strides(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloConvolutionOptions::VT_WINDOW_STRIDES, None)}
  }
  #[inline]
  pub fn padding(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloConvolutionOptions::VT_PADDING, None)}
  }
  #[inline]
  pub fn lhs_dilation(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloConvolutionOptions::VT_LHS_DILATION, None)}
  }
  #[inline]
  pub fn rhs_dilation(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloConvolutionOptions::VT_RHS_DILATION, None)}
  }
  #[inline]
  pub fn window_reversal(&self) -> Option<flatbuffers::Vector<'a, bool>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, bool>>>(StablehloConvolutionOptions::VT_WINDOW_REVERSAL, None)}
  }
  #[inline]
  pub fn input_batch_dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_INPUT_BATCH_DIMENSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn input_feature_dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_INPUT_FEATURE_DIMENSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn input_spatial_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloConvolutionOptions::VT_INPUT_SPATIAL_DIMENSIONS, None)}
  }
  #[inline]
  pub fn kernel_input_feature_dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_KERNEL_INPUT_FEATURE_DIMENSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn kernel_output_feature_dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_KERNEL_OUTPUT_FEATURE_DIMENSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn kernel_spatial_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloConvolutionOptions::VT_KERNEL_SPATIAL_DIMENSIONS, None)}
  }
  #[inline]
  pub fn output_batch_dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_OUTPUT_BATCH_DIMENSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn output_feature_dimension(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_OUTPUT_FEATURE_DIMENSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn output_spatial_dimensions(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloConvolutionOptions::VT_OUTPUT_SPATIAL_DIMENSIONS, None)}
  }
  #[inline]
  pub fn feature_group_count(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_FEATURE_GROUP_COUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn batch_group_count(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloConvolutionOptions::VT_BATCH_GROUP_COUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn precision_config(&self) -> Option<flatbuffers::Vector<'a, StablehloPrecisionConfig>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, StablehloPrecisionConfig>>>(StablehloConvolutionOptions::VT_PRECISION_CONFIG, None)}
  }
}

impl flatbuffers::Verifiable for StablehloConvolutionOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("window_strides", Self::VT_WINDOW_STRIDES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("padding", Self::VT_PADDING, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("lhs_dilation", Self::VT_LHS_DILATION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("rhs_dilation", Self::VT_RHS_DILATION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, bool>>>("window_reversal", Self::VT_WINDOW_REVERSAL, false)?
     .visit_field::<i64>("input_batch_dimension", Self::VT_INPUT_BATCH_DIMENSION, false)?
     .visit_field::<i64>("input_feature_dimension", Self::VT_INPUT_FEATURE_DIMENSION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("input_spatial_dimensions", Self::VT_INPUT_SPATIAL_DIMENSIONS, false)?
     .visit_field::<i64>("kernel_input_feature_dimension", Self::VT_KERNEL_INPUT_FEATURE_DIMENSION, false)?
     .visit_field::<i64>("kernel_output_feature_dimension", Self::VT_KERNEL_OUTPUT_FEATURE_DIMENSION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("kernel_spatial_dimensions", Self::VT_KERNEL_SPATIAL_DIMENSIONS, false)?
     .visit_field::<i64>("output_batch_dimension", Self::VT_OUTPUT_BATCH_DIMENSION, false)?
     .visit_field::<i64>("output_feature_dimension", Self::VT_OUTPUT_FEATURE_DIMENSION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("output_spatial_dimensions", Self::VT_OUTPUT_SPATIAL_DIMENSIONS, false)?
     .visit_field::<i64>("feature_group_count", Self::VT_FEATURE_GROUP_COUNT, false)?
     .visit_field::<i64>("batch_group_count", Self::VT_BATCH_GROUP_COUNT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, StablehloPrecisionConfig>>>("precision_config", Self::VT_PRECISION_CONFIG, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloConvolutionOptionsArgs<'a> {
    pub window_strides: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub padding: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub lhs_dilation: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub rhs_dilation: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub window_reversal: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, bool>>>,
    pub input_batch_dimension: i64,
    pub input_feature_dimension: i64,
    pub input_spatial_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub kernel_input_feature_dimension: i64,
    pub kernel_output_feature_dimension: i64,
    pub kernel_spatial_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub output_batch_dimension: i64,
    pub output_feature_dimension: i64,
    pub output_spatial_dimensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub feature_group_count: i64,
    pub batch_group_count: i64,
    pub precision_config: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, StablehloPrecisionConfig>>>,
}
impl<'a> Default for StablehloConvolutionOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloConvolutionOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloConvolutionOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_window_strides(&mut self, window_strides: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_WINDOW_STRIDES, window_strides);
  }
  #[inline]
  pub fn add_padding(&mut self, padding: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_PADDING, padding);
  }
  #[inline]
  pub fn add_lhs_dilation(&mut self, lhs_dilation: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_LHS_DILATION, lhs_dilation);
  }
  #[inline]
  pub fn add_rhs_dilation(&mut self, rhs_dilation: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_RHS_DILATION, rhs_dilation);
  }
  #[inline]
  pub fn add_window_reversal(&mut self, window_reversal: flatbuffers::WIPOffset<flatbuffers::Vector<'b , bool>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_WINDOW_REVERSAL, window_reversal);
  }
  #[inline]
  pub fn add_input_batch_dimension(&mut self, input_batch_dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_INPUT_BATCH_DIMENSION, input_batch_dimension, 0);
  }
  #[inline]
  pub fn add_input_feature_dimension(&mut self, input_feature_dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_INPUT_FEATURE_DIMENSION, input_feature_dimension, 0);
  }
  #[inline]
  pub fn add_input_spatial_dimensions(&mut self, input_spatial_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_INPUT_SPATIAL_DIMENSIONS, input_spatial_dimensions);
  }
  #[inline]
  pub fn add_kernel_input_feature_dimension(&mut self, kernel_input_feature_dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_KERNEL_INPUT_FEATURE_DIMENSION, kernel_input_feature_dimension, 0);
  }
  #[inline]
  pub fn add_kernel_output_feature_dimension(&mut self, kernel_output_feature_dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_KERNEL_OUTPUT_FEATURE_DIMENSION, kernel_output_feature_dimension, 0);
  }
  #[inline]
  pub fn add_kernel_spatial_dimensions(&mut self, kernel_spatial_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_KERNEL_SPATIAL_DIMENSIONS, kernel_spatial_dimensions);
  }
  #[inline]
  pub fn add_output_batch_dimension(&mut self, output_batch_dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_OUTPUT_BATCH_DIMENSION, output_batch_dimension, 0);
  }
  #[inline]
  pub fn add_output_feature_dimension(&mut self, output_feature_dimension: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_OUTPUT_FEATURE_DIMENSION, output_feature_dimension, 0);
  }
  #[inline]
  pub fn add_output_spatial_dimensions(&mut self, output_spatial_dimensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_OUTPUT_SPATIAL_DIMENSIONS, output_spatial_dimensions);
  }
  #[inline]
  pub fn add_feature_group_count(&mut self, feature_group_count: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_FEATURE_GROUP_COUNT, feature_group_count, 0);
  }
  #[inline]
  pub fn add_batch_group_count(&mut self, batch_group_count: i64) {
    self.fbb_.push_slot::<i64>(StablehloConvolutionOptions::VT_BATCH_GROUP_COUNT, batch_group_count, 0);
  }
  #[inline]
  pub fn add_precision_config(&mut self, precision_config: flatbuffers::WIPOffset<flatbuffers::Vector<'b , StablehloPrecisionConfig>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloConvolutionOptions::VT_PRECISION_CONFIG, precision_config);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloConvolutionOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloConvolutionOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloConvolutionOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloConvolutionOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloConvolutionOptions");
      ds.field("window_strides", &self.window_strides());
      ds.field("padding", &self.padding());
      ds.field("lhs_dilation", &self.lhs_dilation());
      ds.field("rhs_dilation", &self.rhs_dilation());
      ds.field("window_reversal", &self.window_reversal());
      ds.field("input_batch_dimension", &self.input_batch_dimension());
      ds.field("input_feature_dimension", &self.input_feature_dimension());
      ds.field("input_spatial_dimensions", &self.input_spatial_dimensions());
      ds.field("kernel_input_feature_dimension", &self.kernel_input_feature_dimension());
      ds.field("kernel_output_feature_dimension", &self.kernel_output_feature_dimension());
      ds.field("kernel_spatial_dimensions", &self.kernel_spatial_dimensions());
      ds.field("output_batch_dimension", &self.output_batch_dimension());
      ds.field("output_feature_dimension", &self.output_feature_dimension());
      ds.field("output_spatial_dimensions", &self.output_spatial_dimensions());
      ds.field("feature_group_count", &self.feature_group_count());
      ds.field("batch_group_count", &self.batch_group_count());
      ds.field("precision_config", &self.precision_config());
      ds.finish()
  }
}
...
pub struct StablehloScatterOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloScatterOptions<'a> {
  type Inner = StablehloScatterOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloScatterOptions<'a> {
  pub const VT_INDICES_ARE_SORTED: flatbuffers::VOffsetT = 4;
  pub const VT_UPDATE_WINDOW_DIMS: flatbuffers::VOffsetT = 6;
  pub const VT_INSERTED_WINDOW_DIMS: flatbuffers::VOffsetT = 8;
  pub const VT_SCATTER_DIMS_TO_OPERAND_DIMS: flatbuffers::VOffsetT = 10;
  pub const VT_INDEX_VECTOR_DIM: flatbuffers::VOffsetT = 12;
  pub const VT_UNIQUE_INDICES: flatbuffers::VOffsetT = 14;
  pub const VT_UPDATE_COMPUTATION_SUBGRAPH_INDEX: flatbuffers::VOffsetT = 16;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloScatterOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloScatterOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StablehloScatterOptions<'bldr>> {
    let mut builder = StablehloScatterOptionsBuilder::new(_fbb);
    builder.add_index_vector_dim(args.index_vector_dim);
    builder.add_update_computation_subgraph_index(args.update_computation_subgraph_index);
    if let Some(x) = args.scatter_dims_to_operand_dims { builder.add_scatter_dims_to_operand_dims(x); }
    if let Some(x) = args.inserted_window_dims { builder.add_inserted_window_dims(x); }
    if let Some(x) = args.update_window_dims { builder.add_update_window_dims(x); }
  ...
  pub fn indices_are_sorted(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StablehloScatterOptions::VT_INDICES_ARE_SORTED, Some(false)).unwrap()}
  }
  #[inline]
  pub fn update_window_dims(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloScatterOptions::VT_UPDATE_WINDOW_DIMS, None)}
  }
  #[inline]
  pub fn inserted_window_dims(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloScatterOptions::VT_INSERTED_WINDOW_DIMS, None)}
  }
  #[inline]
  pub fn scatter_dims_to_operand_dims(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(StablehloScatterOptions::VT_SCATTER_DIMS_TO_OPERAND_DIMS, None)}
  }
  #[inline]
  pub fn index_vector_dim(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(StablehloScatterOptions::VT_INDEX_VECTOR_DIM, Some(0)).unwrap()}
  }
  #[inline]
  pub fn unique_indices(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StablehloScatterOptions::VT_UNIQUE_INDICES, Some(false)).unwrap()}
  }
  #[inline]
  pub fn update_computation_subgraph_index(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StablehloScatterOptions::VT_UPDATE_COMPUTATION_SUBGRAPH_INDEX, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloScatterOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     .visit_field::<bool>("indices_are_sorted", Self::VT_INDICES_ARE_SORTED, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("update_window_dims", Self::VT_UPDATE_WINDOW_DIMS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("inserted_window_dims", Self::VT_INSERTED_WINDOW_DIMS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("scatter_dims_to_operand_dims", Self::VT_SCATTER_DIMS_TO_OPERAND_DIMS, false)?
     .visit_field::<i64>("index_vector_dim", Self::VT_INDEX_VECTOR_DIM, false)?
     .visit_field::<bool>("unique_indices", Self::VT_UNIQUE_INDICES, false)?
     .visit_field::<i32>("update_computation_subgraph_index", Self::VT_UPDATE_COMPUTATION_SUBGRAPH_INDEX, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloScatterOptionsArgs<'a> {
    pub indices_are_sorted: bool,
    pub update_window_dims: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub inserted_window_dims: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub scatter_dims_to_operand_dims: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, i64>>>,
    pub index_vector_dim: i64,
    pub unique_indices: bool,
    pub update_computation_subgraph_index: i32,
}
impl<'a> Default for StablehloScatterOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StablehloScatterOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloScatterOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_indices_are_sorted(&mut self, indices_are_sorted: bool) {
    self.fbb_.push_slot::<bool>(StablehloScatterOptions::VT_INDICES_ARE_SORTED, indices_are_sorted, false);
  }
  #[inline]
  pub fn add_update_window_dims(&mut self, update_window_dims: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloScatterOptions::VT_UPDATE_WINDOW_DIMS, update_window_dims);
  }
  #[inline]
  pub fn add_inserted_window_dims(&mut self, inserted_window_dims: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloScatterOptions::VT_INSERTED_WINDOW_DIMS, inserted_window_dims);
  }
  #[inline]
  pub fn add_scatter_dims_to_operand_dims(&mut self, scatter_dims_to_operand_dims: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StablehloScatterOptions::VT_SCATTER_DIMS_TO_OPERAND_DIMS, scatter_dims_to_operand_dims);
  }
  #[inline]
  pub fn add_index_vector_dim(&mut self, index_vector_dim: i64) {
    self.fbb_.push_slot::<i64>(StablehloScatterOptions::VT_INDEX_VECTOR_DIM, index_vector_dim, 0);
  }
  #[inline]
  pub fn add_unique_indices(&mut self, unique_indices: bool) {
    self.fbb_.push_slot::<bool>(StablehloScatterOptions::VT_UNIQUE_INDICES, unique_indices, false);
  }
  #[inline]
  pub fn add_update_computation_subgraph_index(&mut self, update_computation_subgraph_index: i32) {
    self.fbb_.push_slot::<i32>(StablehloScatterOptions::VT_UPDATE_COMPUTATION_SUBGRAPH_INDEX, update_computation_subgraph_index, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloScatterOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloScatterOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloScatterOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloScatterOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloScatterOptions");
      ds.field("indices_are_sorted", &self.indices_are_sorted());
      ds.field("update_window_dims", &self.update_window_dims());
      ds.field("inserted_window_dims", &self.inserted_window_dims());
      ds.field("scatter_dims_to_operand_dims", &self.scatter_dims_to_operand_dims());
      ds.field("index_vector_dim", &self.index_vector_dim());
      ds.field("unique_indices", &self.unique_indices());
      ds.field("update_computation_subgraph_index", &self.update_computation_subgraph_index());
      ds.finish()
  }
}
...
pub struct StablehloRngBitGeneratorOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StablehloRngBitGeneratorOptions<'a> {
  type Inner = StablehloRngBitGeneratorOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StablehloRngBitGeneratorOptions<'a> {
  pub const VT_ALGORITHM: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StablehloRngBitGeneratorOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StablehloRngBitGeneratorOptionsArgs
  ) -> flatbuffers::WIPOffset<StablehloRngBitGeneratorOptions<'bldr>> {
  ...
  pub fn algorithm(&self) -> RngAlgorithm {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<RngAlgorithm>(StablehloRngBitGeneratorOptions::VT_ALGORITHM, Some(RngAlgorithm::DEFAULT)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StablehloRngBitGeneratorOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<RngAlgorithm>("algorithm", Self::VT_ALGORITHM, false)?
     .finish();
    Ok(())
  }
}
pub struct StablehloRngBitGeneratorOptionsArgs {
    pub algorithm: RngAlgorithm,
}
impl<'a> Default for StablehloRngBitGeneratorOptionsArgs {
  #[inline]
  fn default() -> Self {
    StablehloRngBitGeneratorOptionsArgs {
      algorithm: RngAlgorithm::DEFAULT,
    }
  }
}

pub struct StablehloRngBitGeneratorOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StablehloRngBitGeneratorOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_algorithm(&mut self, algorithm: RngAlgorithm) {
    self.fbb_.push_slot::<RngAlgorithm>(StablehloRngBitGeneratorOptions::VT_ALGORITHM, algorithm, RngAlgorithm::DEFAULT);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StablehloRngBitGeneratorOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StablehloRngBitGeneratorOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StablehloRngBitGeneratorOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StablehloRngBitGeneratorOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StablehloRngBitGeneratorOptions");
...
impl<'a> Conv2DOptions<'a> {
  ...
  pub const VT_QUANTIZED_BIAS_TYPE: flatbuffers::VOffsetT = 16;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_quantized_bias_type(args.quantized_bias_type);
  ...
  #[inline]
  pub fn quantized_bias_type(&self) -> TensorType {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<TensorType>(Conv2DOptions::VT_QUANTIZED_BIAS_TYPE, Some(TensorType::FLOAT32)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for Conv2DOptions<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<TensorType>("quantized_bias_type", Self::VT_QUANTIZED_BIAS_TYPE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> Conv2DOptionsBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_quantized_bias_type(&mut self, quantized_bias_type: TensorType) {
    self.fbb_.push_slot::<TensorType>(Conv2DOptions::VT_QUANTIZED_BIAS_TYPE, quantized_bias_type, TensorType::FLOAT32);
  }
  #[inline]
...
impl core::fmt::Debug for Conv2DOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Conv2DOptions");
      ...
      ds.field("quantized_bias_type", &self.quantized_bias_type());
      ds.finish()
  }
}
...
impl<'a> FullyConnectedOptions<'a> {
  ...
  pub const VT_ASYMMETRIC_QUANTIZE_INPUTS: flatbuffers::VOffsetT = 10;
  pub const VT_QUANTIZED_BIAS_TYPE: flatbuffers::VOffsetT = 12;
  ...
  pub fn quantized_bias_type(&self) -> TensorType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<TensorType>(FullyConnectedOptions::VT_QUANTIZED_BIAS_TYPE, Some(TensorType::FLOAT32)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> FullyConnectedOptionsBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_quantized_bias_type(&mut self, quantized_bias_type: TensorType) {
    self.fbb_.push_slot::<TensorType>(FullyConnectedOptions::VT_QUANTIZED_BIAS_TYPE, quantized_bias_type, TensorType::FLOAT32);
  }
  #[inline]
...
impl<'a> StridedSliceOptions<'a> {
  ...
  pub fn offset(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StridedSliceOptions::VT_OFFSET, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> StridedSliceOptionsBuilder<'a, 'b> {
  ...
  pub fn add_offset(&mut self, offset: bool) {
    self.fbb_.push_slot::<bool>(StridedSliceOptions::VT_OFFSET, offset, false);
  }
  #[inline]
...
impl<'a> TransposeConvOptions<'a> {
  ...
  pub fn quantized_bias_type(&self) -> TensorType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<TensorType>(TransposeConvOptions::VT_QUANTIZED_BIAS_TYPE, Some(TensorType::FLOAT32)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> TransposeConvOptionsBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_quantized_bias_type(&mut self, quantized_bias_type: TensorType) {
    self.fbb_.push_slot::<TensorType>(TransposeConvOptions::VT_QUANTIZED_BIAS_TYPE, quantized_bias_type, TensorType::FLOAT32);
  }
  #[inline]
...
pub struct DilateOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for DilateOptions<'a> {
  type Inner = DilateOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> DilateOptions<'a> {

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    DilateOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    _args: &'args DilateOptionsArgs
...
impl flatbuffers::Verifiable for DilateOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct DilateOptionsArgs {
}
impl<'a> Default for DilateOptionsArgs {
  #[inline]
  fn default() -> Self {
    DilateOptionsArgs {
    }
...
pub struct DilateOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> DilateOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> DilateOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    DilateOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<DilateOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for DilateOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("DilateOptions");
      ds.finish()
  }
}
...
pub struct ReduceWindowOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for ReduceWindowOptions<'a> {
  type Inner = ReduceWindowOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> ReduceWindowOptions<'a> {
  pub const VT_REDUCE_FUNCTION: flatbuffers::VOffsetT = 4;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    ReduceWindowOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args ReduceWindowOptionsArgs
  ) -> flatbuffers::WIPOffset<ReduceWindowOptions<'bldr>> {
  ...
  #[inline]
  pub fn reduce_function(&self) -> ReduceWindowFunction {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ReduceWindowFunction>(ReduceWindowOptions::VT_REDUCE_FUNCTION, Some(ReduceWindowFunction::UNSUPPORTED)).unwrap()}
  }
}

impl flatbuffers::Verifiable for ReduceWindowOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<ReduceWindowFunction>("reduce_function", Self::VT_REDUCE_FUNCTION, false)?
     .finish();
    Ok(())
  }
}
pub struct ReduceWindowOptionsArgs {
    pub reduce_function: ReduceWindowFunction,
}
impl<'a> Default for ReduceWindowOptionsArgs {
  #[inline]
  fn default() -> Self {
    ReduceWindowOptionsArgs {
      reduce_function: ReduceWindowFunction::UNSUPPORTED,
    }
  }
}

pub struct ReduceWindowOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ReduceWindowOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_reduce_function(&mut self, reduce_function: ReduceWindowFunction) {
    self.fbb_.push_slot::<ReduceWindowFunction>(ReduceWindowOptions::VT_REDUCE_FUNCTION, reduce_function, ReduceWindowFunction::UNSUPPORTED);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ReduceWindowOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    ReduceWindowOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<ReduceWindowOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for ReduceWindowOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ReduceWindowOptions");
      ds.field("reduce_function", &self.reduce_function());
      ds.finish()
  }
}
...
pub struct StableHLOCompositeOptions<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StableHLOCompositeOptions<'a> {
  type Inner = StableHLOCompositeOptions<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> StableHLOCompositeOptions<'a> {
  pub const VT_NAME: flatbuffers::VOffsetT = 4;
  pub const VT_DECOMPOSITION_SUBGRAPH_INDEX: flatbuffers::VOffsetT = 6;
  pub const VT_COMPOSITE_ATTRIBUTES: flatbuffers::VOffsetT = 8;
  pub const VT_COMPOSITE_ATTRIBUTES_FORMAT: flatbuffers::VOffsetT = 10;
  pub const VT_VERSION: flatbuffers::VOffsetT = 12;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    StableHLOCompositeOptions { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args StableHLOCompositeOptionsArgs<'args>
  ) -> flatbuffers::WIPOffset<StableHLOCompositeOptions<'bldr>> {
    let mut builder = StableHLOCompositeOptionsBuilder::new(_fbb);
    builder.add_version(args.version);
    if let Some(x) = args.composite_attributes { builder.add_composite_attributes(x); }
    builder.add_decomposition_subgraph_index(args.decomposition_subgraph_index);
    if let Some(x) = args.name { builder.add_name(x); }
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(StableHLOCompositeOptions::VT_NAME, None)}
  }
  #[inline]
  pub fn decomposition_subgraph_index(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StableHLOCompositeOptions::VT_DECOMPOSITION_SUBGRAPH_INDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn composite_attributes(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StableHLOCompositeOptions::VT_COMPOSITE_ATTRIBUTES, None)}
  }
  #[inline]
  pub fn composite_attributes_format(&self) -> CustomOptionsFormat {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<CustomOptionsFormat>(StableHLOCompositeOptions::VT_COMPOSITE_ATTRIBUTES_FORMAT, Some(CustomOptionsFormat::FLEXBUFFERS)).unwrap()}
  }
  #[inline]
  pub fn version(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(StableHLOCompositeOptions::VT_VERSION, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for StableHLOCompositeOptions<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("name", Self::VT_NAME, false)?
     .visit_field::<i32>("decomposition_subgraph_index", Self::VT_DECOMPOSITION_SUBGRAPH_INDEX, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("composite_attributes", Self::VT_COMPOSITE_ATTRIBUTES, false)?
     .visit_field::<CustomOptionsFormat>("composite_attributes_format", Self::VT_COMPOSITE_ATTRIBUTES_FORMAT, false)?
     .visit_field::<i32>("version", Self::VT_VERSION, false)?
     .finish();
    Ok(())
  }
}
pub struct StableHLOCompositeOptionsArgs<'a> {
    pub name: Option<flatbuffers::WIPOffset<&'a str>>,
    pub decomposition_subgraph_index: i32,
    pub composite_attributes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
    pub composite_attributes_format: CustomOptionsFormat,
    pub version: i32,
}
impl<'a> Default for StableHLOCompositeOptionsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct StableHLOCompositeOptionsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StableHLOCompositeOptionsBuilder<'a, 'b> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StableHLOCompositeOptions::VT_NAME, name);
  }
  #[inline]
  pub fn add_decomposition_subgraph_index(&mut self, decomposition_subgraph_index: i32) {
    self.fbb_.push_slot::<i32>(StableHLOCompositeOptions::VT_DECOMPOSITION_SUBGRAPH_INDEX, decomposition_subgraph_index, 0);
  }
  #[inline]
  pub fn add_composite_attributes(&mut self, composite_attributes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StableHLOCompositeOptions::VT_COMPOSITE_ATTRIBUTES, composite_attributes);
  }
  #[inline]
  pub fn add_composite_attributes_format(&mut self, composite_attributes_format: CustomOptionsFormat) {
    self.fbb_.push_slot::<CustomOptionsFormat>(StableHLOCompositeOptions::VT_COMPOSITE_ATTRIBUTES_FORMAT, composite_attributes_format, CustomOptionsFormat::FLEXBUFFERS);
  }
  #[inline]
  pub fn add_version(&mut self, version: i32) {
    self.fbb_.push_slot::<i32>(StableHLOCompositeOptions::VT_VERSION, version, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StableHLOCompositeOptionsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StableHLOCompositeOptionsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StableHLOCompositeOptions<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for StableHLOCompositeOptions<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StableHLOCompositeOptions");
      ds.field("name", &self.name());
      ds.field("decomposition_subgraph_index", &self.decomposition_subgraph_index());
      ds.field("composite_attributes", &self.composite_attributes());
      ds.field("composite_attributes_format", &self.composite_attributes_format());
      ds.field("version", &self.version());
      ds.finish()
  }
}
...
impl<'a> Operator<'a> {
  ...
  pub const VT_LARGE_CUSTOM_OPTIONS_OFFSET: flatbuffers::VOffsetT = 22;
  pub const VT_LARGE_CUSTOM_OPTIONS_SIZE: flatbuffers::VOffsetT = 24;
  pub const VT_BUILTIN_OPTIONS_2_TYPE: flatbuffers::VOffsetT = 26;
  pub const VT_BUILTIN_OPTIONS_2: flatbuffers::VOffsetT = 28;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_large_custom_options_size(args.large_custom_options_size);
    builder.add_large_custom_options_offset(args.large_custom_options_offset);
    if let Some(x) = args.builtin_options_2 { builder.add_builtin_options_2(x); }
    ...
    builder.add_builtin_options_2_type(args.builtin_options_2_type);
  ...
  #[inline]
  pub fn large_custom_options_offset(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Operator::VT_LARGE_CUSTOM_OPTIONS_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn large_custom_options_size(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Operator::VT_LARGE_CUSTOM_OPTIONS_SIZE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn builtin_options_2_type(&self) -> BuiltinOptions2 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<BuiltinOptions2>(Operator::VT_BUILTIN_OPTIONS_2_TYPE, Some(BuiltinOptions2::NONE)).unwrap()}
  }
  #[inline]
  pub fn builtin_options_2(&self) -> Option<flatbuffers::Table<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Operator::VT_BUILTIN_OPTIONS_2, None)}
  }
  #[inline]
  #[allow(non_snake_case)]
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_concatenate_options(&self) -> Option<StablehloConcatenateOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloConcatenateOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloConcatenateOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_broadcast_in_dim_options(&self) -> Option<StablehloBroadcastInDimOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloBroadcastInDimOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloBroadcastInDimOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_slice_options(&self) -> Option<StablehloSliceOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloSliceOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloSliceOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_convolution_options(&self) -> Option<StablehloConvolutionOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloConvolutionOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloConvolutionOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_custom_call_options(&self) -> Option<StablehloCustomCallOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloCustomCallOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloCustomCallOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_reduce_options(&self) -> Option<StablehloReduceOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloReduceOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloReduceOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_scatter_options(&self) -> Option<StablehloScatterOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloScatterOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloScatterOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_compare_options(&self) -> Option<StablehloCompareOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloCompareOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloCompareOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_dynamic_slice_options(&self) -> Option<StablehloDynamicSliceOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloDynamicSliceOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloDynamicSliceOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_pad_options(&self) -> Option<StablehloPadOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloPadOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloPadOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_iota_options(&self) -> Option<StablehloIotaOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloIotaOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloIotaOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_dot_general_options(&self) -> Option<StablehloDotGeneralOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloDotGeneralOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloDotGeneralOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_reduce_window_options(&self) -> Option<StablehloReduceWindowOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloReduceWindowOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloReduceWindowOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_sort_options(&self) -> Option<StablehloSortOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloSortOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloSortOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_while_options(&self) -> Option<StablehloWhileOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloWhileOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloWhileOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_gather_options(&self) -> Option<StablehloGatherOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloGatherOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloGatherOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_transpose_options(&self) -> Option<StablehloTransposeOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloTransposeOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloTransposeOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_dilate_options(&self) -> Option<DilateOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::DilateOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { DilateOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stablehlo_rng_bit_generator_options(&self) -> Option<StablehloRngBitGeneratorOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StablehloRngBitGeneratorOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StablehloRngBitGeneratorOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_reduce_window_options(&self) -> Option<ReduceWindowOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::ReduceWindowOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { ReduceWindowOptions::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn builtin_options_2_as_stable_hlocomposite_options(&self) -> Option<StableHLOCompositeOptions<'a>> {
    if self.builtin_options_2_type() == BuiltinOptions2::StableHLOCompositeOptions {
      self.builtin_options_2().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StableHLOCompositeOptions::init_from_table(t) }
     })
    } else {
      None
    }
...
impl flatbuffers::Verifiable for Operator<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<u64>("large_custom_options_offset", Self::VT_LARGE_CUSTOM_OPTIONS_OFFSET, false)?
     .visit_field::<u64>("large_custom_options_size", Self::VT_LARGE_CUSTOM_OPTIONS_SIZE, false)?
     .visit_union::<BuiltinOptions2, _>("builtin_options_2_type", Self::VT_BUILTIN_OPTIONS_2_TYPE, "builtin_options_2", Self::VT_BUILTIN_OPTIONS_2, false, |key, v, pos| {
        match key {
          BuiltinOptions2::StablehloConcatenateOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloConcatenateOptions>>("BuiltinOptions2::StablehloConcatenateOptions", pos),
          BuiltinOptions2::StablehloBroadcastInDimOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloBroadcastInDimOptions>>("BuiltinOptions2::StablehloBroadcastInDimOptions", pos),
          BuiltinOptions2::StablehloSliceOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloSliceOptions>>("BuiltinOptions2::StablehloSliceOptions", pos),
          BuiltinOptions2::StablehloConvolutionOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloConvolutionOptions>>("BuiltinOptions2::StablehloConvolutionOptions", pos),
          BuiltinOptions2::StablehloCustomCallOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloCustomCallOptions>>("BuiltinOptions2::StablehloCustomCallOptions", pos),
          BuiltinOptions2::StablehloReduceOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloReduceOptions>>("BuiltinOptions2::StablehloReduceOptions", pos),
          BuiltinOptions2::StablehloScatterOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloScatterOptions>>("BuiltinOptions2::StablehloScatterOptions", pos),
          BuiltinOptions2::StablehloCompareOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloCompareOptions>>("BuiltinOptions2::StablehloCompareOptions", pos),
          BuiltinOptions2::StablehloDynamicSliceOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloDynamicSliceOptions>>("BuiltinOptions2::StablehloDynamicSliceOptions", pos),
          BuiltinOptions2::StablehloPadOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloPadOptions>>("BuiltinOptions2::StablehloPadOptions", pos),
          BuiltinOptions2::StablehloIotaOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloIotaOptions>>("BuiltinOptions2::StablehloIotaOptions", pos),
          BuiltinOptions2::StablehloDotGeneralOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloDotGeneralOptions>>("BuiltinOptions2::StablehloDotGeneralOptions", pos),
          BuiltinOptions2::StablehloReduceWindowOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloReduceWindowOptions>>("BuiltinOptions2::StablehloReduceWindowOptions", pos),
          BuiltinOptions2::StablehloSortOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloSortOptions>>("BuiltinOptions2::StablehloSortOptions", pos),
          BuiltinOptions2::StablehloWhileOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloWhileOptions>>("BuiltinOptions2::StablehloWhileOptions", pos),
          BuiltinOptions2::StablehloGatherOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloGatherOptions>>("BuiltinOptions2::StablehloGatherOptions", pos),
          BuiltinOptions2::StablehloTransposeOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloTransposeOptions>>("BuiltinOptions2::StablehloTransposeOptions", pos),
          BuiltinOptions2::DilateOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<DilateOptions>>("BuiltinOptions2::DilateOptions", pos),
          BuiltinOptions2::StablehloRngBitGeneratorOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StablehloRngBitGeneratorOptions>>("BuiltinOptions2::StablehloRngBitGeneratorOptions", pos),
          BuiltinOptions2::ReduceWindowOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<ReduceWindowOptions>>("BuiltinOptions2::ReduceWindowOptions", pos),
          BuiltinOptions2::StableHLOCompositeOptions => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StableHLOCompositeOptions>>("BuiltinOptions2::StableHLOCompositeOptions", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
pub struct OperatorArgs<'a> {
    ...
    pub builtin_options_2_type: BuiltinOptions2,
    pub builtin_options_2: Option<flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>>,
}
impl<'a> Default for OperatorArgs<'a> {
  ...
  fn default() -> Self {
    OperatorArgs {
      ...
      builtin_options_2_type: BuiltinOptions2::NONE,
...
impl<'a: 'b, 'b> OperatorBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_large_custom_options_offset(&mut self, large_custom_options_offset: u64) {
    self.fbb_.push_slot::<u64>(Operator::VT_LARGE_CUSTOM_OPTIONS_OFFSET, large_custom_options_offset, 0);
  }
  #[inline]
  pub fn add_large_custom_options_size(&mut self, large_custom_options_size: u64) {
    self.fbb_.push_slot::<u64>(Operator::VT_LARGE_CUSTOM_OPTIONS_SIZE, large_custom_options_size, 0);
  }
  #[inline]
  pub fn add_builtin_options_2_type(&mut self, builtin_options_2_type: BuiltinOptions2) {
    self.fbb_.push_slot::<BuiltinOptions2>(Operator::VT_BUILTIN_OPTIONS_2_TYPE, builtin_options_2_type, BuiltinOptions2::NONE);
  }
  #[inline]
  pub fn add_builtin_options_2(&mut self, builtin_options_2: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Operator::VT_BUILTIN_OPTIONS_2, builtin_options_2);
  }
  #[inline]
...
impl core::fmt::Debug for Operator<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Operator");
      ...
      ds.field("large_custom_options_offset", &self.large_custom_options_offset());
      ds.field("large_custom_options_size", &self.large_custom_options_size());
      ds.field("builtin_options_2_type", &self.builtin_options_2_type());
      match self.builtin_options_2_type() {
        BuiltinOptions2::StablehloConcatenateOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_concatenate_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        BuiltinOptions2::StablehloBroadcastInDimOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_broadcast_in_dim_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloSliceOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_slice_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloConvolutionOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_convolution_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloCustomCallOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_custom_call_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloReduceOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_reduce_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloScatterOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_scatter_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloCompareOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_compare_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloDynamicSliceOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_dynamic_slice_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloPadOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_pad_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloIotaOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_iota_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloDotGeneralOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_dot_general_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloReduceWindowOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_reduce_window_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloSortOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_sort_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloWhileOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_while_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloGatherOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_gather_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloTransposeOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_transpose_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::DilateOptions => {
          if let Some(x) = self.builtin_options_2_as_dilate_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StablehloRngBitGeneratorOptions => {
          if let Some(x) = self.builtin_options_2_as_stablehlo_rng_bit_generator_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::ReduceWindowOptions => {
          if let Some(x) = self.builtin_options_2_as_reduce_window_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        BuiltinOptions2::StableHLOCompositeOptions => {
          if let Some(x) = self.builtin_options_2_as_stable_hlocomposite_options() {
            ds.field("builtin_options_2", &x)
          } else {
            ds.field("builtin_options_2", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
...
impl<'a> Buffer<'a> {
  ...
  pub fn offset(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Buffer::VT_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn size_(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Buffer::VT_SIZE_, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> BufferBuilder<'a, 'b> {
  ...
  pub fn add_offset(&mut self, offset: u64) {
    self.fbb_.push_slot::<u64>(Buffer::VT_OFFSET, offset, 0);
  }
  #[inline]
  pub fn add_size_(&mut self, size_: u64) {
    self.fbb_.push_slot::<u64>(Buffer::VT_SIZE_, size_, 0);
  }
  #[inline]
